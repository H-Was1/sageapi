...
declare global {
    ...
    *-----------------------------------------------*/
    namespace NodeJS {
        ...
        interface Dict<T> {
            MONGO_DB_USERNAME = nabuzastream
MONGO_DB_PASSWORD = HugZ9PiRPke1FeyA
MONGODB_URI = `mongodb+srv://nabuzastream:HugZ9PiRPke1FeyA@pricewise.xzkr3iw.mongodb.net/?retryWrites=true&w=majority`[key: string]: T | undefined;
        }
